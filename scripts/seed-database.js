...
// Sample genres data
const sampleGenres = [
  { id: '1', name: 'Fiction', slug: 'fiction', description: 'Imaginative storytelling', isActive: true, bookCount: 0 },
  { id: '2', name: 'Non-Fiction', slug: 'non-fiction', description: 'Factual and educational content', isActive: true, bookCount: 0 },
  { id: '3', name: 'Romance', slug: 'romance', description: 'Love stories and relationships', isActive: true, bookCount: 0 },
  { id: '4', name: 'Mystery & Thriller', slug: 'mystery-thriller', description: 'Suspenseful and mysterious stories', isActive: true, bookCount: 0 },
  { id: '5', name: 'Science Fiction', slug: 'science-fiction', description: 'Futuristic and scientific themes', isActive: true, bookCount: 0 },
  { id: '6', name: 'Fantasy', slug: 'fantasy', description: 'Magical and supernatural elements', isActive: true, bookCount: 0 },
  { id: '7', name: 'Horror', slug: 'horror', description: 'Scary and suspenseful content', isActive: true, bookCount: 0 },
  { id: '8', name: 'Biography & Memoir', slug: 'biography-memoir', description: 'Personal life stories', isActive: true, bookCount: 0 },
  { id: '9', name: 'Self-Help', slug: 'self-help', description: 'Personal development and improvement', isActive: true, bookCount: 0 },
  { id: '10', name: 'Business & Economics', slug: 'business-economics', description: 'Professional and economic content', isActive: true, bookCount: 0 },
  { id: '11', name: 'History', slug: 'history', description: 'Historical events and periods', isActive: true, bookCount: 0 },
  { id: '12', name: 'Science & Technology', slug: 'science-technology', description: 'Scientific and technological content', isActive: true, bookCount: 0 },
  { id: '13', name: 'Health & Fitness', slug: 'health-fitness', description: 'Wellness and physical health', isActive: true, bookCount: 0 },
  { id: '14', name: 'Travel', slug: 'travel', description: 'Travel guides and experiences', isActive: true, bookCount: 0 },
  { id: '15', name: 'Cooking', slug: 'cooking', description: 'Recipes and culinary content', isActive: true, bookCount: 0 },
  { id: '16', name: 'Poetry', slug: 'poetry', description: 'Poetic and lyrical content', isActive: true, bookCount: 0 },
  { id: '17', name: 'Drama', slug: 'drama', description: 'Dramatic and theatrical content', isActive: true, bookCount: 0 },
  { id: '18', name: 'Comedy', slug: 'comedy', description: 'Humorous and entertaining content', isActive: true, bookCount: 0 },
  { id: '19', name: 'Adventure', slug: 'adventure', description: 'Exciting and adventurous stories', isActive: true, bookCount: 0 },
  { id: '20', name: 'Educational', slug: 'educational', description: 'Learning and instructional content', isActive: true, bookCount: 0 }
];
